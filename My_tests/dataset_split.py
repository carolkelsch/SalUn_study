...
class UnlearnDatasetSplit:
    ...
    def __init__(self, path: str, dataset: str):
        ...
        self.available_datasets = ["cifar-10", "coco"]
        self.possible_splits = ["Train", "Valid", "Test", "Train_retain", "Train_retain_MIA", "Train_forget", "Test_retain", "Test_forget"]
    ...
    def get_dataset(self, dataset: str):
        ...
        if isinstance(dataset, list) or not isinstance(dataset, str):
            print(f"\033[31mInvalid dataset\r\n Please pick between {self.available_datasets}!\033[0m")
            return None
